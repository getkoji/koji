...
CREATE UNIQUE INDEX IF NOT EXISTS "projects_tenant_slug_idx" ON "projects" USING btree ("tenant_id","slug") WHERE deleted_at IS NULL;--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "projects_tenant_idx" ON "projects" USING btree ("tenant_id") WHERE deleted_at IS NULL;--> statement-breakpoint
