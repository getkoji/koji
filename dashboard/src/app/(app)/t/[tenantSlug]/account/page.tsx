      ...
      <div className="flex-1 overflow-y-auto px-10 pt-6 pb-8 max-w-2xl">
        {loading ? (
          ...
          <>
                ...
                {user?.authProvider !== "local" ? (
                  <>
                    <div className="space-y-1.5">
                      ...
                      <div className="text-[13px] text-ink-3 h-[30px] flex items-center">{name || "—"}</div>
                    </div>
                    <div className="space-y-1.5">
                      <label className="text-[12.5px] font-medium text-ink">Email</label>
                      <div className="text-[13px] text-ink-3 h-[30px] flex items-center">{email}</div>
                    </div>
                    <p className="text-[11px] text-ink-4">Profile managed by your identity provider.</p>
                  </>
                ) : (
                  <>
                    <div className="space-y-1.5">
            ...
            {/* Password — only for built-in auth, not Clerk/SSO */}
